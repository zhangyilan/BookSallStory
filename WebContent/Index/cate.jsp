...
<style type="text/css">
  ...
  <body text=""  background="">
	<center>
   <font color="red" size="5px">更新图书类别</font><br>
		
		<form action="${pageContext.request.contextPath }/Adminservlet?opt=addcate" method="post">
			<table>
	
				<tr><td><font color="red">**</font>请输入要增添的图书类别：</td><td><input type="text" size="30" name="category_name"/></td></tr><tr><td>&nbsp;</td></tr>
		...
		<form action="${pageContext.request.contextPath }/Adminservlet?opt=detelecate" method="post">
			<table>
			
				<tr><td><font color="red">**</font>请选择要删除的图书类别：</td><td>
					<!-- 下拉列表的id值在select的name中得到 -->
					<select name="dele_cateid" id="info" >
